...
export const App: React.FC = () => {
  ...
  const [writtenScript, setWrittenScript] = useState(true)
    ...
    <ChakraProvider theme={theme}>
      ...
      <Main>
        <VStack pt='100px' pb={10} px={{ base: 4, md: 8 }} w='100%'>
          ...
          <ButtonGroup spacing={{ base: 2, md: 4 }} w='100%' justifyContent='center' isDisabled={initValue === '' || !writtenScript}>
          ...
          <Box mt={4} d='block' w='100%' px={{ base: 0, md: '15%' }}>
            ...
            <ScriptArea setWrittenScript={setWrittenScript} />
          </Box>
        </VStack>
      </Main>
    </ChakraProvider>
